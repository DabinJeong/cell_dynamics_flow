"""Geodesic interpolant correction network h(x0, x1, t).

Code identical to kkapusniak/metric-flow-matching (module docstring added): mfm/networks/geopath_networks/mlp.py.
"""
...
from mfm.networks.mlp_base import SimpleDenseNet
